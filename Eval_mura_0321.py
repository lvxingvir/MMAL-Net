...
def parse_arg():
    ...
    parser.add_argument('--model_name', help='model name',
                        default={'Elbow':'mura_onlyappm_0321_Elbow',
                                 'Finger':'mura_onlyappm_0321_Finger',
                                 'Forearm':'mura_onlyappm_0321_Forearm',
                                 'Hand':'mura_onlyappm_0321_Hand',
                                 'Humerus':'mura_onlyappm_0321_Humerus',
                                 'Shoulder':'mura_onlyappm_0321_Shoulder',
                                 'Wrist':'mura_onlyappm_0321_Wrist'}, type=dict)
...
class Eval_mura(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        self.df.to_csv('eval_result_window_0321.csv')

        self.rendering(y,pred,title='Normal Window 0321')

        self.rendering(st_y, st_pred, title='Study Window 0321')
